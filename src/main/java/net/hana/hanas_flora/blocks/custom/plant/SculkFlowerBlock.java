package net.hana.hanas_flora.blocks.custom.plant;

import java.util.List;

import com.mojang.serialization.MapCodec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import net.hana.hanas_flora.blocks.custom.plant.SculkPlantBlock;
...
extends SculkPlantBlock
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        tooltip.add(Text.translatable("tooltip.hanas_flora.sculk_flower_block.tooltip"));

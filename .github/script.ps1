...
$apiUrl = "https://api.modrinth.com/v2/project//version"
...
$headers = @{
    "User-Agent" = "ThievishJoke/Hanas-Flora (GitHub Actions)"
}
...
if ($version_id -ne $previous_version_id) {
    ...
    $url = "https://modrinth.com/mod/hanas-flora/version/$version_id"
